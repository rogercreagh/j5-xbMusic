...
/*******
 * @package xbMusic
 * @filesource admin/src/Table/ArtistTable.php
...
class ArtistTable extends Table implements VersionableTableInterface, TaggableTableInterface {
    ...
    {
        $this->typeAlias = 'com_xbmusic.artist';
        
        parent::__construct('#__xbmusic_artists', 'id', $db, $dispatcher);
