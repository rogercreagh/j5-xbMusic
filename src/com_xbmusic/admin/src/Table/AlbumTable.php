...
/*******
 * @package xbMusic
 * @filesource admin/src/Table/AlbumTable.php
...
class AlbumTable extends Table implements VersionableTableInterface, TaggableTableInterface {
    ...
    {
        $this->typeAlias = 'com_xbmusic.album';
        
        parent::__construct('#__xbmusic_albums', 'id', $db, $dispatcher);
...
//         }
        ...
        // Set default value if catid empty.
         if ($this->catid =='') {
//             $this->catid = ($this->params->get('defcat_album')=='') ? XbcommonHelper::getCatByAlias('uncategorised') : $this->params->get('defcat_album');
             $this->catid = $this->params->get('defcat_album',XbcommonHelper::getCatByAlias('uncategorised'));
         }
