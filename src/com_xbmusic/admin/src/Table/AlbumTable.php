...
//         }
        ...
        // Set default value if catid empty.
         if ($this->catid =='') {
//             $this->catid = ($this->params->get('defcat_album')=='') ? XbmusicHelper::getCatByAlias('uncategorised') : $this->params->get('defcat_album');
             $this->catid = $this->params->get('defcat_album',XbmusicHelper::getCatByAlias('uncategorised'));
         }
