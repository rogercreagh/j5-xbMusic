		...
		<div class="row">
			<div class= "col-sm-4">
				<div class="xbbox <?php echo ($item->albumcnt>0) ? 'gradyellow' : 'xbbggy'; ?>">
					...
					echo Xbtext::_('XBMUSIC_ALBUMS',XBSP3 + XBTRL).Text::_('XB_IN_CATEGORY'); ?>  
			...
			<div class= "col-sm-4">
				<div class="xbbox <?php echo ($item->artistcnt > 0) ? 'gradblue' : 'xbbggy'; ?>">
					...
					echo Xbtext::_('XBMUSIC_ARTISTS',XBSP3 + XBTRL).Text::_('XB_IN_CATEGORY'); ?>  
						<span class="xblabel label-cat"><?php echo $item->title; ?></span></p>
			...
			<div class= "col-sm-4">
				<div class="xbbox <?php echo ($item->playlistcnt > 0) ? 'gradpink' : 'xbbggy'; ?>">
					...
					echo Xbtext::_('XBMUSIC_PLAYLISTS',XBSP3 + XBTRL).Text::_('XB_IN_CATEGORY'); ?>  
						<span class="xblabel label-cat"><?php echo $item->title; ?></span></p>
		...
		<div class="row">
			<div class= "col-sm-4">
				<div class="xbbox <?php echo ($item->songcnt>0) ? 'gradcyan' : 'xbbggy'; ?>">
					...
					echo Xbtext::_('XBMUSIC_SONGS',XBSP3 + XBTRL).Text::_('XB_IN_CATEGORY'); ?>  
						<span class="xblabel label-cat"><?php echo $item->title; ?></span></p>
			...
			<div class= "col-sm-4">
				<div class="xbbox <?php echo ($item->trackcnt > 0) ? 'gradgreen' : 'xbbggy'; ?>">
					...
					echo Xbtext::_('XBMUSIC_TRACKS',XBSP3 + XBTRL).Text::_('XB_IN_CATEGORY'); ?>  
						<span class="xblabel label-cat"><?php echo $item->title; ?></span></p>
