 ...
 * @var   string   $isNested        Flag, to enable sticky selections in list
...
if ($readonly) {
    ...
    // E.g. form field type xbtags sends $this->value as array
...
Text::script('JGLOBAL_SELECT_PRESS_TO_SELECT');
    ...
    $document->addScript(Uri::root().'media/vendor/choicesjs/js/choices.min.js');
    $document->addStyleSheet(Uri::root().'media/vendor/choicesjs/css/choices.min.css');

Factory::getApplication()->getDocument()->getWebAssetManager()
//    ->useStyle('xbchoicesjs')
